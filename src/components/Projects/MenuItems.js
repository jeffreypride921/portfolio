export const MenuItems = [{
    ...
    {
        title: 'To-Do List',
        desc: 'Interactable To-Do list utilizing CRUD operations. Create, delete, and cross out items on your own personal To-Do list. Created in Angular.',
        github: 'https://github.com/jeffreypride921/todo-app',
        img: '/images/todo.png',
